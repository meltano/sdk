...
| [`UUID()`](inv:python:py:class:#uuid.UUID) | Parses and validates a UUID value. Use `str(UUID(value))` to return its canonical string representation. |
| [`uuid4()`](inv:python:py:function:#uuid.uuid4) | Generates a random UUID and returns its string representation. |
