...
class _HTTPStream(Stream, abc.ABC, t.Generic[_TToken]):  # noqa: PLR0904
    ...
    def build_prepared_request(
        ...
        **kwargs: t.Any,
        ...
        request.headers.setdefault("User-Agent", self.user_agent)  # type: ignore[attr-defined] # ty: ignore[unresolved-attribute]
    ...
    def get_http_request(self, *, page: PageContext) -> HTTPRequest:
        ...
        on the stream context or pagination token. By default, this method constructs an
        HTTP request using:

        - The URL generated by :meth:`~get_url` with the stream context.
        - The HTTP method defined in :attr:`~http_method`.
        - The HTTP headers defined in :attr:`~http_headers`.
        - The URL parameters defined in :meth:`~get_url_params` with the stream context
          and pagination token.
        - The request body defined in :meth:`~prepare_request_payload` with the stream
          context and pagination token.
    ...
    def _prepare_request(
        ...
        *,
        ...
        prepare_kwargs: dict[str, t.Any] = {
            ...
            "params": http_request.encode_params(),
            "headers": http_request.headers,
        }

        if self.payload_as_json:
            prepare_kwargs["json"] = http_request.data
        else:
            prepare_kwargs["data"] = http_request.data
