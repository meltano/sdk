...
class SQLConnector:  # noqa: PLR0904
    ...
    def get_sqlalchemy_url(self, config: dict[str, t.Any]) -> str:  # noqa: PLR6301
        ...
        return config["sqlalchemy_url"]  # type: ignore[no-any-return]
    ...
    def delete_where_sdc_deleted_at_is_not_null(
        self,
        *,
        full_table_name: str | FullyQualifiedName,
        sdc_deleted_at_column: str,
    ) -> int:
        """Hard-delete rows where the soft delete column is set.
        ...
        Args:
            full_table_name: The fully qualified table name.
            sdc_deleted_at_column: The name of the soft delete column.
        ...
        query = sa.text(
            f"DELETE FROM {full_table_name} "  # noqa: S608
            f"WHERE {sdc_deleted_at_column} IS NOT NULL",
        )
