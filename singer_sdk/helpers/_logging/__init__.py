"""Logging helpers for the Singer SDK."""
...
class StructuredFormatter(logging.Formatter):
    ...
    def __init__(
        ...
        Args:
            *args: Positional arguments for the parent formatter.
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        """
        # Create a copy of the record's __dict__ to avoid modifying the original
...
class ContextualLoggerAdapter(logging.LoggerAdapter):
    ...
    def __init__(
        self, logger: logging.Logger, extra: dict[str, t.Any] | None = None
    ) -> None:
