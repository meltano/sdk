...
def python_versions(package_metadata: PackageMetadata) -> list[str]:
    ...
    requires_python = package_metadata.get("Requires-Python", f">={_PY_MIN_VERSION}")  # type: ignore[attr-defined,unused-ignore]  # ty:ignore[unresolved-attribute,unused-ignore-comment]
    classifiers = [
