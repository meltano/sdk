...
- Add description attribute to `Property` class for JSON schemas  ([#159](https://gitlab.com/meltano/sdk/-/merge_requests/160) -- _Thanks, **[Stephen Bailey](https://gitlab.com/stkbailey)**!_
